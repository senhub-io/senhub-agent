...
```yaml
# probes.d/10-ping_gateway.yaml — each file under probes.d/ is a YAML array of probes
- name: ping_gateway
  params:
...
5. **Report issues:**
   ...
   - Include manual ping test results
