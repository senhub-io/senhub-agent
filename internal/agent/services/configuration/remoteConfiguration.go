...
# -------------------------------
# In version 2 format:
#   - 'name': Display name for identification in UI (free choice)
#   - 'type': Probe type identifier (technical name: cpu, citrix, redfish, etc.)
#
...
#         interval: 120
#
#     - name: Datacenter 1 Redfish     # Another display name
#       type: redfish                  # Probe type (fixed identifier)
#       params:
#         endpoint: "https://ilo.example.com"
#
# This allows multiple instances of the same probe type with different configurations.
# =============================================================================
...
# Available strategies: senhub, prtg, event, http
storage:
%s

# Probes configuration (from server)
# Each probe monitors specific infrastructure components
probes:
%s

# =============================================================================
# Additional Probes Available (Commented Examples)
# =============================================================================
...
# Agent version: Automatically synced with server
# =============================================================================
`
