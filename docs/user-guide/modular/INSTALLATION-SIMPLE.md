...
1. Configure your monitoring probes (see Configuration section)
2. Activate your license if you have premium probes (see License section in Configuration)
3. Set up HTTPS if required (see HTTP/HTTPS Configuration section)
4. Configure your monitoring system (PRTG, Nagios, Grafana) to collect metrics (see Web Interface section)
