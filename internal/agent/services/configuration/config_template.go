...
// generated config.
const LicenseDocumentationTemplate = `  # Paid-tier probes: drop the license.jwt file (from Sensor Factory) next to this config — no file = free tier. See agent.senhub.io/docs. (An inline 'license:' JWT still works and is auto-migrated to license.jwt on next start.)`
