...
const (
	...
	// Additional relevant Windows error codes
	ERROR_RPC_S_SERVER_UNAVAILABLE uint32 = 1722
	ERROR_RPC_S_CALL_CANCELLED     uint32 = 1818
	ERROR_EVT_QUERY_RESULT_STALE   uint32 = 15011
	ERROR_EVT_PUBLISHER_DISABLED   uint32 = 15037
)
