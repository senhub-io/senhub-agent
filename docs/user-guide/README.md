...
2. Fix list formatting (ensure blank lines before lists)
3. Transform cross-file links to internal anchors
4. Extract Mermaid diagram code from markdown blocks
5. Convert each diagram to PNG using mermaid-cli
6. Replace Mermaid blocks with image references
7. Generate Word document with single global TOC and embedded images

**Document structure:**
- Single global table of contents (generated by Pandoc)
- No intermediate/local TOC sections
- Each chapter starts on a new page (Heading 1 page break)
...
- Increased line and paragraph spacing for readability
