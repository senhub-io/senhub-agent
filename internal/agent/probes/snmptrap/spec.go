...
func init() {
	probes.RegisterProbeSpec(probes.ProbeSpec{
		...
		Params: []probes.ParamSpec{
			...
			{Key: "version", Kind: probes.KindString, Default: "v2c", Enum: []string{"v2c", "v3"}, Group: "connection", Description: "SNMP version of the traps accepted; v3 needs v3.users"},
			...
			{Key: "v3", Kind: probes.KindBlock, Group: "auth", Description: "SNMPv3 users", Fields: []probes.ParamSpec{
				{Key: "users", Kind: probes.KindBlockList, Required: true, Fields: []probes.ParamSpec{
					...
					{Key: "auth_protocol", Kind: probes.KindString, Enum: []string{"MD5", "SHA", "SHA224", "SHA256", "SHA384", "SHA512"}, Description: "Authentication protocol of this user; empty means no authentication"},
					{Key: "auth_password", Kind: probes.KindString, Secret: true, Description: "Authentication passphrase of this user"},
					{Key: "priv_protocol", Kind: probes.KindString, Enum: []string{"DES", "AES", "AES192", "AES256"}, Description: "Privacy (encryption) protocol of this user; needs auth_protocol"},
					{Key: "priv_password", Kind: probes.KindString, Secret: true, Description: "Privacy passphrase of this user"},
				}},
			}},
		},
	})
