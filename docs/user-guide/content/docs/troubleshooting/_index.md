...
- **Firewall blocking the port**: See Firewall Configuration in the [HTTP/HTTPS section]({{< relref "/docs/http-https" >}})
...
- **Probe not in license tier**: Verify the probe type is included in your tier. See the License Tiers table in the [Configuration section]({{< relref "/docs/configuration" >}}).
...
- **Missing lookups**: Install PRTG Lookups for status metrics (see [Web Interface section]({{< relref "/docs/web-interface" >}}))
