...
**Processing pipeline:**
1. Extract cross-file links and transform to internal anchors
2. Extract Mermaid diagram code from markdown blocks
3. Convert each diagram to PNG using mermaid-cli
4. Replace Mermaid blocks with image references
5. Generate Word document with embedded images
