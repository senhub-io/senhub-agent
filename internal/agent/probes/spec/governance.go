...
func GovernanceFields() []ParamSpec {
	return []ParamSpec{
		...
		{Key: "location", Kind: KindBlock, Description: "Where it is", Fields: []ParamSpec{
			{Key: "site", Kind: KindString, Description: "Site name"},
			{Key: "datacenter", Kind: KindString, Description: "Datacenter name"},
			{Key: "rack", Kind: KindString, Description: "Rack identifier"},
			{Key: "room", Kind: KindString, Description: "Room identifier"},
		}},
