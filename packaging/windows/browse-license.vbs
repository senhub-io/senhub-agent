...
Function BrowseLicenseFile()
  ...
  tmp = fso.GetSpecialFolder(2) & "\senhub-license-pick.txt"
  ...
  ps = "Add-Type -AssemblyName System.Windows.Forms;" & _
       ...
       "$d=New-Object System.Windows.Forms.OpenFileDialog;$d.Title='Select the SenHub Agent license file';" & _
       "$d.Filter='License files (*.jwt)|*.jwt|All files (*.*)|*.*';$d.CheckFileExists=$true;$d.Multiselect=$false;" & _
