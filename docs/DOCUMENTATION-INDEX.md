...
| **[Entity ↔ Telemetry Contract](developer-guide/engineering/ENTITY-TELEMETRY-CONTRACT.md)** | How an entity's identity reaches its metrics/logs/traces, and where the round trip is guaranteed | Developers |
